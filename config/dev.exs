...
config :agenticrealms, AgenticRealmsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "80+gFz45Bo7JWdA4B3FtPWgJ0chtaIwmBScjX1P5apvXqHrUdH1cK2ruGf/FWUWu",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:agenticrealms, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:agenticrealms, ~w(--watch)]}
  ]
...
config :agenticrealms, dev_routes: true
