defmodule AgenticRealmsWeb.GameLiveNPCTest do
  ...
  alias AgenticRealms.World.Schemas.NPC
  ...
  test "static NPCs — US1, US2, US3, US4 in sequence",
    ...
    # Foundational sanity (also covers T010 + T016 — projector and queries
    # smoke). After Seed.run/0 the world_npcs read model has Garrick.
    assert [%NPC{name: "Garrick the Innkeeper", room_id: room_id}] = Repo.all(NPC)
